...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter
{
    ...
    // -1 says keep token valid as long as application is up & running or until user signs out
    ...
    {
        // Storing in memory is very secure, much more secure than a system's disk space, and fast
        clients.inMemory()
